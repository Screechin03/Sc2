                    ...
                    {[...Array(3)].map((_, index) => (
                        <div key={index} className="flex flex-shrink-0">
                            {dataUpper.map((item, i) => (
                                <div key={i} className="relative mx-8">
                                    <img
                                        src={box}
                                        alt="Partner Box"
                                    ...
                                    <img
                                        ...
                                        className="absolute top-6 lg:top-13 md:top-13 left-0 w-12 h-12 md:w-22 md:h-22 object-contain"
                                    />
