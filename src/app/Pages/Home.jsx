...
export default function Home() {
  ...
  return (
    <div
      className="relative flex flex-col gap-3 min-h-screen overflow-x-hidden"
      style={{
        background:
          "linear-gradient(to bottom, #063254 0%, #004484 10%, #004484 61%, #01193D 86%)",
        width: "100%",
        maxWidth: "100vw",
      }}
    >
      ...
      >
        <source
          src="/537d97592d242580cfeedf0083ac44a75d06f8e4.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <img
        ...
        className="w-8 absolute top-35 left-28 h-8 z-[2] hidden sm:block"
      />
      <img
        src="/Group 85.png"
        alt="Background Element"
        className="w-7 absolute top-51 left-3 h-7 z-[2] block sm:hidden"
      />
      <img
        src="/Group 85.png"
        alt="Background Element"
        className="w-6 absolute top-65 right-3 h-6 z-[2] block sm:hidden"
      />
      <img
        src="/Group 87.png"
        alt="Background Element"
        className="w-7 absolute top-75 right-67 h-7 z-[2]  hidden sm:block"
      />
      <img
        src="/Group 86.png"
        alt="Background Element"
        className="w-6 absolute top-103 right-157 h-6 z-[2] hidden sm:block"
      />
      <img
        src="/Comet.svg"
        alt="Background Element"
        className="w-34 absolute top-20 right-24 h-34 z-[2] hidden sm:block"
      />
      <img
        src="/Group 129.svg"
        alt="Background Element"
        className="w-10 absolute top-140 right-24 h-10 opacity-80 z-[2] hidden sm:block"
      />
      ...
      <div className="relative flex flex-col items-center justify-center min-h-auto text-white font-ticketing mt-19 z-[3] pb-32">
        ...
        <>
          ...
          <img
            src="/Vector (4).png"
            className="block sm:hidden mb-4 mt-9"
            alt="Mobile Vector"
          />
        </>
        ...
        <div className="-mt-25 relative flex flex-col items-center justify-center w-full z-[2]">
          <div className="flex flex-col absolute inset-0 w-full h-full z-[2]">
            <p className="mt-28 bg-gradient-to-r from-[#A5FECB] to-[#A5FECB] via-[#92EFFD] text-transparent bg-clip-text  font-ticketing mx-8 text-center opacity-100 text-base absolute z-20 block sm:hidden">
              Unleash your creativity and join Status Code 2, the ultimate
              36-hour hackathon extravaganza! Compete across diverse categories,
              showcasing your skills, ingenuity, and collaborative spirit
              alongside like-minded individuals. Discover the perfect platform
              to challenge yourself.
            </p>
            <img
              src="/Base.svg"
              alt="Background Element"
              className="w-full absolute top-74 h-auto opacity-100 hidden sm:block"
            />
            <img
              src="/Group 225.svg"
              alt="Background Element"
              className="w-full absolute top-134 h-auto opacity-70 blur-[1px] block sm:hidden "
            />
            <img
              src="/Rectangle 3.png"
              className="absolute -z-0 w-full right-0 opacity-70 h-60 top-117 blur-[8px] hidden sm:block "
            />
            <img
              src="/Rectangle 3.png"
              className="absolute -z-0 w-full right-0 opacity-80 h-60 top-123 hidden sm:block blur-[8px] transform scale-y-[-1]"
            />
            <img
              src="/Rectangle 3.png"
              className="absolute -z-0 w-full right-0 opacity-100 h-60 top-183 block sm:hidden blur-[8px] transform scale-y-[-1]"
            />
            <img
              style={{ clipPath: "inset(0 0 30% 0)" }}
              src="/Rectangle 3.png"
              className="absolute top-99 z-7 blur-[9px] opacity-80 w-full"
            />
      ...
      <img
        src="/Rectangle 3.png"
        className=" w-full right-0 opacity-80 h-60 top-123 sm:block blur-[8px] transform scale-y-[-1] -mt-70"
      />
