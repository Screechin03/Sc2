...
const Faqs = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "There are no participation fees for this hackathon. It's completely free!",
    },
    {
        ...
        {faqs.map((faq, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              <button
                className={`w-8 h-8 flex items-center justify-center transform transition-transform duration-300 ${
            ...
            {openIndex === index && (
              <p className="mt-2 pl-12 text-[#92DEFF] z-80">{faq.answer}</p>
            )}
          </div>
        ))}
      </div>
